...
# Add this at the very top to prevent duplicate imports
if 'gunicorn' in os.environ.get('SERVER_SOFTWARE', ''):
    # If running under gunicorn, check if we've already imported
    if 'weather_prediction_app' in sys.modules:
        print("App already imported, skipping re-import")
        # Get the existing app from the module
        from weather_prediction_app import app as existing_app
        app = existing_app
    else:
        # First import, proceed normally
    ...
    # Not running under gunicorn, use normal imports
    from flask import Flask, render_template, request, jsonify, send_file
    import requests
    from datetime import datetime, timedelta
    import numpy as np
